...
<main>
    ...
    <div class="flex w-full space-y-3 md:space-y-0 mt-8 text-center md:text-left px-2 flex-col mx-auto md:flex-row justify-center">
        <div class="font-Teachers px-3 w-[90%] mx-auto py-1 z-auto md:w-1/3 rounded-lg bg-slate-300  border hover:bg-purple-100 border-gray-800 hover:border-black duration-150 transition-all ease-in hover:scale-105">
            ...
            <div class="mt-3 text-sm">
                ...
                <p>Ultima Creacion: <a href="#" class="text-blue-500 font-bold hover:border-b-[2px] border-blue-400 duration-100 transition-all ease-in">Encuesta sobre la Salud Mental</a></p>
        ...
        <div class="font-Teachers  w-[90%] mb-4 mx-auto text-center md:text-left md:w-1/3 px-3 py-1 rounded-lg bg-slate-300  border hover:bg-purple-100 hover:border-black duration-150 transition-all ease-in hover:scale-105">
