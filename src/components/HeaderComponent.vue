    ...
    <header>
        <nav class="w-full p-1 bg-slate-50 shadow-lg">
            <ul class="flex justify-between m-2 items-center">
                ...
                <li class="space-x-3 p-2 hidden lg:flex text-white">
                    <router-link :to="{name: 'pagPrincipal'}" class="rounded-md px-3 py-1 flex items-center space-x-2 bg-purple-500 ring-[1.5px] ring-purple-500 hover:bg-white hover:text-purple-500 transition-all ease-in-out duration-100">
                        <UsuarioIcono />
                        <span>Mi Perfil</span>
                    </router-link>
                    <router-link :to="{name:'crear'}" class="rounded-md px-3 py-1 flex items-center space-x-2 bg-blue-500 ring-[1.5px] ring-blue-500 hover:bg-white hover:text-blue-500 transition-all ease-in-out duration-100">
                        <CrearIcono />
                        <span>Crear</span>
                    </router-link>
